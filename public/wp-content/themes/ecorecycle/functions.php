...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) {
	...
	include_once($root.'/wp-content/plugins/woocommerce/includes/admin/wc-admin-functions.php');
		...
		*/
		...
		if(!$default_colors || !$default_colors['primary'] || $default_colors['primary'] == '#ad74a2'){
			update_option('woocommerce_frontend_css_colors',array(
				...
				'content_bg' => $pmc_data['boxColor'],
				'subtext' => $pmc_data['body_font']['color'],
			));
	...
	/*add_filter( 'woocommerce_enqueue_styles', 'pmc_dequeue_styles' );
	function pmc_dequeue_styles( $enqueue_styles ) {
